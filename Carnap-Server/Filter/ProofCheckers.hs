...
activate cls extra chunk
    ...
    | "KooKMM-SL"        `elem` cls = exTemplate [("system", "KooKMM-SL"),("options","indent fonts resize render")]
...
toPlayground cls extra content
    ...
    | "KooKMM-SL"        `elem` cls = playTemplate [("system", "KooKMM-SL"),("options","indent fonts resize render")]
